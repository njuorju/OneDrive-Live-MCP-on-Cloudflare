...
export function registerVisualCatalogueCompilerTools(server: McpServer, contextFactory: () => HotfixContext): void {
  ...
  server.registerTool("start_visual_catalogue_job", {
    ...
    inputSchema: {
      ...
      classifierProvider: z.enum(["openai", "opencode_zen", "opencode_go", "fixture"]).optional(),
      classifierMode: z.enum(["openai_responses", "openai_batch", "opencode_chat_completions", "opencode_go_chat_completions", "fixture"]).optional(),
