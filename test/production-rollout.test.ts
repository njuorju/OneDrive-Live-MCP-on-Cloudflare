...
test("ODL-REQ-029 deployment is exact-main, post-CI, leased, and does not run provider diagnostics", () => {
  ...
  assert.match(workflow, /OPENING_VERSION_ID: b1c31b28-4c1a-4425-a176-4b11b894d091/);
  assert.match(workflow, /OPENING_DEPLOYMENT_ID: a5abdd4a-c481-4188-86a3-516486c9295d/);
  ...
  assert.match(workflow, /Deploy ODL-REQ-029 exact main/);
  assert.match(workflow, /odl-req-029-\$\{GITHUB_SHA:0:12\}/);
  ...
  assert.match(workflow, /odl-req-029-deployment-evidence/);
